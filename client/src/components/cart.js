  ...
  return (
    <div>
      ...
      <input
        ...
        onChange={(e) => changeCartValue(e.target.value, product)}
        onBlur={(e) => constrainCartValue(e.target.value, product)}
      ></input>
      <button type="button" onClick={() => removeItemFromCart(product)}>
